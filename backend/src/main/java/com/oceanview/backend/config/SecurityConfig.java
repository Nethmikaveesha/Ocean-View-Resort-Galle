    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/rooms", "/api/rooms/available", "/api/rooms/available-for-dates", "/api/rooms/*").permitAll()
                        .requestMatchers("/api/rooms/**").hasAnyRole("ADMIN", "MANAGER")
                        .requestMatchers(HttpMethod.GET, "/api/reservations/availability").permitAll()
                        .requestMatchers("/api/reservations/**").hasAnyRole("CUSTOMER", "ADMIN", "MANAGER", "RECEPTIONIST")
                        .requestMatchers("/api/customers/**").hasAnyRole("ADMIN", "MANAGER")
                        .requestMatchers("/api/admins/**").hasRole("ADMIN")
                        .requestMatchers("/api/bills/**").hasAnyRole("CUSTOMER", "ADMIN", "MANAGER", "RECEPTIONIST")
