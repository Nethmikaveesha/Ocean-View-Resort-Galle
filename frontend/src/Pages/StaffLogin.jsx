  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.data?.token) {
        ...
        if (role === "customer") {
          setError("Customer accounts must use Check Availability, select a room, then log in from that page.");
          return;
        }
        ...
        <div className="bg-white/70 backdrop-blur-lg rounded-3xl shadow-2xl p-8 sm:p-10 border border-white/20 animate-[fadeInUp_0.6s_ease-out]">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600 text-sm leading-relaxed">
              Admin, Manager, and Receptionist access only. Customers must use Check Availability to book.
            </p>
          </div>
